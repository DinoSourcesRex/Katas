...
Background:
	...
	And the following edits to an existing customer
		| Id | Name | PreviouslyOrdered | WebCustomer | LastActive | FavouriteColours |
		| 1  | Odin | True              | True        | 01-01-2017 | Red,Blue,Green   |

Scenario: When a customer is editted are the changes visible
